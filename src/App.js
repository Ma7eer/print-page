...
export default class App extends Component {
  ...
  handleSubmit = (e) => {
    ...
    Axios.get(`https://dashboard.alrahma-baraka.com:5000/family/print/${this.state.formId}`, {headers:{Authorization: "Bearer" + localStorage.getItem("jwtToken")}})
    // .then(res => console.log(res.data))
      ...
      Axios.get(`https://dashboard.alrahma-baraka.com:5000/visitReports/print/${this.state.formId}`, {headers:{Authorization: "Bearer" + localStorage.getItem("jwtToken")}})
        .then(res => this.setState({
